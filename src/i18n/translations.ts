export const translations = {
  ...
  sv: {
    translation: {
      ...
      filterByBrand: "Filtrera efter Varumärke",
      ...
      chooseVariant: "Välj din föredragna variant",
      ...
      cartEmptyDesc: "Lägg till produkter för att komma igång",
      browseProductsBtn: "Bläddra bland Produkter",
      remove: "Ta bort",
